...
<form method="post" action="<portlet:actionURL />">
    <div class="osivia-portal-table">
        <div class="osivia-portal-row">
            ...
            <div class="osivia-portal-cell"><input type="text" name="groups-count" required="required" size="1" maxlength="1" /></div>
        </div>
        <div class="osivia-portal-row">
            <div class="osivia-portal-cell"><p>Profondeur de l'arbre des groupes :</p></div>
            <div class="osivia-portal-cell"><input type="text" name="groups-depth" required="required" size="1" maxlength="1" /></div>
        </div>
        <div class="osivia-portal-row">
            <div class="osivia-portal-cell"><p>Nombre d'utilisateurs :</p></div>
            <div class="osivia-portal-cell"><input type="text" name="users-count" required="required" size="4" maxlength="4" /></div>
        </div>
        <div class="osivia-portal-row">
            ...
            <div class="osivia-portal-cell">
                ...
                <input type="number" name="users-probability-3" size="4" />
        ...
        <div class="osivia-portal-row">
            ...
            <div class="osivia-portal-cell"><input type="text" name="documents-count" required="required" size="1" maxlength="1" /></div>
        </div>
        <div class="osivia-portal-row">
            <div class="osivia-portal-cell"><p>Nombre de notes par noeud :</p></div>
            <div class="osivia-portal-cell"><input type="text" name="documents-notes-count" required="required" size="1" maxlength="1" /></div>
        </div>
        <div class="osivia-portal-row">
            <div class="osivia-portal-cell"><p>Profondeur de l'arbre des pages :</p></div>
            <div class="osivia-portal-cell"><input type="text" name="documents-depth" required="required" size="1" maxlength="1" /></div>
        </div>
        <div class="osivia-portal-row">
            <div class="osivia-portal-cell"><p>Probabilités d'appartenance des notes à des groupes :</p></div>
            <div class="osivia-portal-cell">
                <input type="number" name="documents-probability-1" size="4" />
