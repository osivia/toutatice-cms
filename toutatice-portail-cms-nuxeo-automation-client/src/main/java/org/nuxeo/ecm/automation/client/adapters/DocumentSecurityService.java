...
public class DocumentSecurityService {
     ...
     * @throws Exception
     */
    public Document removePermissions (Document document, DocumentPermissions permissions, List<String> userNames, String acl, boolean removeAll, boolean blockInheritance) throws Exception {
        // Coherence check
        if(blockInheritance && INHERITED_ACL.equalsIgnoreCase(acl)){
