 ...
 * This class directly extends AbstractAutomationClient instead of AsyncAutomationClient
 * (performance issue during shutdown ( delay of 2 s. with java synchronization)
 * 
