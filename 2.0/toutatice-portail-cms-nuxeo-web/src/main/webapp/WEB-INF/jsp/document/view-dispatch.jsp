...
<% 	
	if("annonce".equals(doc.getType().toLowerCase()) || ( "note".equals(doc.getType().toLowerCase()) ) || ( "file".equals(doc.getType().toLowerCase()) ) || ( "contextuallink".equals(doc.getType().toLowerCase()) ) )	{
