...
<form action="${saveUrl}" method="post" class="form-horizontal" role="form">
    ...
    <div class="form-group">
        <label for="${namespace}-label" class="col-sm-3 control-label"><op:translate key="SELECTOR_LABEL" /></label>
        <div class="col-sm-9">
    ...
    <!-- Identifier -->
    <div class="form-group">
        <label for="${namespace}-id" class="col-sm-3 control-label"><op:translate key="SELECTOR_IDENTIFIER" /></label>
        <div class="col-sm-9">
    ...
    <!-- Vocabulary -->
    <div class="form-group">
        <label for="${namespace}-vocabulary" class="col-sm-3 control-label"><op:translate key="SELECTOR_VOCABULARY" /></label>
        <div class="col-sm-9">
