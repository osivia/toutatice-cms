...
public class LinkFragmentModule implements IFragmentModule {
	 ...
	 */
	public void injectViewAttributes(NuxeoController ctx, PortalWindow window, PortletRequest request,
	 ...
	 */
	public void processAdminAttributes(NuxeoController ctx, PortalWindow window, ActionRequest request,
