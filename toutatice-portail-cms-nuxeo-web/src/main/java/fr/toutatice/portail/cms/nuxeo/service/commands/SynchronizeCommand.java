 ...
 *
 */
public class SynchronizeCommand extends EcmCommand {
	...
	public void notifyAfterCommand(ControllerContext ctx) {
		String success = itlzService.getString("SUCCESS_MESSAGE_SYNCHRONIZE", ctx.getServerInvocation().getRequest().getLocale());
