...
/**
 * Subscribe to all notifications on a document
 * 
 * @author lbillon
 * 
 */
public class NotificationsSubscribe implements INuxeoCommand {
	...
	public NotificationsSubscribe(Document inputDoc) {
	...
	public Object execute(Session nuxeoSession) throws Exception {
		...
		OperationRequest request = nuxeoSession.newRequest("Notification.AllNotificationsSubscribe").setInput(inputDoc);
