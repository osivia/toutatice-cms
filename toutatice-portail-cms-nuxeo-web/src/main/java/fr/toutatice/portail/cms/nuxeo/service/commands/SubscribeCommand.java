 ...
 *
 */
public class SubscribeCommand extends EcmCommand {
	...
	public SubscribeCommand(INotificationsService notifService,
        ...
        super(EcmCommonCommands.subscribe.toString(), ReloadAfterCommandStrategy.REFRESH_NAVIGATION, "Notification.AllNotificationsSubscribe", null);
	...
	public void notifyAfterCommand(ControllerContext ctx) {
		String success = itlzService.getString("SUCCESS_MESSAGE_SUBSCRIBE", ctx.getServerInvocation().getRequest().getLocale());
